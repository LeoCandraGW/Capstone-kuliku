...
abstract class KuliRemoteDataSource {
  ...
  Future<List<KuliModel>> getListKuliSkill(String skill);
...
class KuliRemoteDataSourceImpl implements KuliRemoteDataSource {
  ...
  @override
  Future<List<KuliModel>> getListKuliSkill(String skill) async {
    final response = 
    await client.get(Uri.parse('$BASE_URL/api/kuliskill/$skill'));
